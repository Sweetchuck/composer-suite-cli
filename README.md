...
[![CircleCI](https://circleci.com/gh/Sweetchuck/composer-suite-cli/tree/2.x.svg?style=svg)](https://circleci.com/gh/Sweetchuck/composer-suite-cli/?branch=2.x)
[![codecov](https://codecov.io/gh/Sweetchuck/composer-suite-cli/branch/2.x/graph/badge.svg?token=HSF16OGPyr)](https://app.codecov.io/gh/Sweetchuck/composer-suite-cli/branch/2.x)
